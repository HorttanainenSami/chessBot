...
export function generateArrRectangular() {
  for (let from = 0; from <= 63; from++) {
    const rank = ~~(from / 8);
    const file = from % 8;
    const arrInISquare = Array.apply(null, []);
...
export function getNW(square: number) {
  return bishopNWMasks[square] as Long;
}
export function getNE(square: number) {
  return bishopNEMasks[square] as Long;
}
export function getSW(square: number) {
  return bishopSWMasks[square] as Long;
}
export function getSE(square: number) {
  return bishopSEMasks[square] as Long;
}
export function getBishopMoves(square: number) {
...
export function getN(square: number) {
  return rookNMasks[square] as Long;
}
export function getE(square: number) {
  return rookEMasks[square] as Long;
}
export function getW(square: number) {
  return rookWMasks[square] as Long;
}
export function getS(square: number) {
  return rookSMasks[square] as Long;
}
export function getRookMoves(square: number) {
...
const kingPseudoMoves = ({ kingPosition }: { kingPosition: Long }) => {
